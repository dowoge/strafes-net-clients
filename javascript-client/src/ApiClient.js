...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.StrafesNetPublicApi.ApiClient = factory(root.superagent, root.querystring);
  }
  ...
  var exports = function() {
     ...
     * @type {String}
     * @default https://api.strafes.net/v1
     */
    this.basePath = 'https://api.strafes.net/v1'.replace(/\/+$/, '');
