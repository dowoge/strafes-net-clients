...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.StrafesNetPublicApi.Rank = factory(root.StrafesNetPublicApi.ApiClient);
  }
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('Skill'))
        obj.skill = ApiClient.convertToType(data['Skill'], 'Number');
   ...
   * @member {Number} skill
   */
  exports.prototype.skill = undefined;
